checkpoint_config = dict(interval=1010)
log_config = dict(
...
model = dict(
    ...
    backbone=dict(
        ...
        out_indices=(3,),
        init_cfg=dict(type="Pretrained", checkpoint="swin_v2_base_densesimmim.pth"),
    ),
    transformer=dict(
        type="ARTransformer",
        in_chans=1024,
...
runner = dict(type="IterBasedRunnerMultitask", max_iters=6060)
evaluation = dict(interval=3030)
...
task = dict(
    depth=dict(  # len=24231
        ...
        data=dict(
            train=dict(
                type="nyudepthv2",
                data_path="/media/hungle45/Data/Dataset/nyu_depth_v2/data/nyu2_train/",
                filenames_path="/media/hungle45/Data/Dataset/nyu_depth_v2/data/",
                is_train=True,
                scale_size=(320, 240),
                crop_size=(240, 240),
                samples_total_gpu=8,
            ...
            val=dict(
                type="nyudepthv2",
                data_path="/media/hungle45/Data/Dataset/nyu_depth_v2/data/nyu2_test/",
                filenames_path="/media/hungle45/Data/Dataset/nyu_depth_v2/data/",
                is_train=False,
                scale_size=(320, 240),
                samples_per_gpu=8,
